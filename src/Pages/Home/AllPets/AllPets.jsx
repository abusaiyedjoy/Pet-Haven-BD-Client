...
const AllPets = () => {
    return (
        <section className="pt-4 pb-16 bg-sky-100">
            <Header
                Heading={"🐕Choose Favourite Pets for Adoption🐕"}
            ></Header>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
                <div className="w-full relative max-w-sm hover:scale-105 transition-transform overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
