...
import { GiRabbit, GiButterfly, GiHummingbird } from "react-icons/gi";
...
const Category = () => {
    ...
    const Pets = [
        ...
        },
        {
          _id: "1318",
          category: "Others",
          pet_image: <GiButterfly style={{ width: 72, height: 72 }} />,
          pathName: "others"
        }
      ];
        ...
        <section className="bg-white dark:bg-gray-800">
            <div className="container px-6 py-12 mx-auto">
                ...
                <div className="flex gap-24 flex-wrap justify-center items-center">
                    {
                        Pets?.map(item => <div title="View Details" key={item._id} className="flex w-40 h-40 flex-col items-center p-3 duration-300 transform border cursor-pointer rounded-full group hover:bg-secondary hover:shadow-2xl hover:scale-105 transition-transform dark:border-red-600 dark:hover:border-transparent">
