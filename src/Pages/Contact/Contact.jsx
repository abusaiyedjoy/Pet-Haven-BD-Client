    ...
    return (
        <section className="bg-[#d3d3d3] dark:bg-gray-900">
            ...
            <div className="flex flex-wrap gap-16 my-16">
                <div className="bg-[#F5F2EB] relative dark:bg-gray-700 pb-6 pt-12 px-12 text-center w-lg mx-auto rounded-xl">
                ...
                <div className="bg-[#F5F2EB] relative dark:bg-gray-700 pb-6 pt-12 px-16 text-center w-lg mx-auto rounded-xl">
                ...
                <div className="bg-[#F5F2EB] relative dark:bg-gray-700 pb-6 pt-12 px-16 text-center max-w-lg mx-auto rounded-xl">
            ...
            <div className="max-w-2xl w-auto mx-6 lg:mx-10 xl:mx-16 mt-8">
            ...
            >
                <form
                    className='my-12 mx-8 flex w-full flex-col gap-8 '
                >
