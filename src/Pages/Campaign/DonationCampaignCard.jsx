  ...
  return (
      <div className="flex justify-center items-center gap-3 h-[25vh] overflow-hidden bg-white rounded-lg p-2 shadow-lg dark:bg-gray-800">
        <div
          ...
          style={{ backgroundImage: `url(${campaign.petImage})` }}
        ></div>
        ...
        <div className="w-3/5 p-4 md:p-4">
          ...
          <div className="flex flex-col justify-center space-y-2 mt-3 item-center">
            ...
            <Link to={`/donation`} className="cursor-pointer w-full items-center justify-items-center  rounded-full px-7 py-3 text-xl font-mono font-semibold text-sky-600 hover:text-white border-2 border-sky-600
